...
p{color:green}. Пока Билли Бонс пьёт ром в трактире "Адмирал Бенбоу", его соперник Джон Сильвер собирает команду и готовится считать пиастры....

---

h3. Введение

p. Материал по проекту находится в стадии оформления. Последнее обновление - 2018.02.07

p{color:red}. Используя данный Сайт, Вы выражаете свое согласие с "«Отказом от ответственности»":/disclaimer.html и принимаете всю ответственность за выполняемые действия с оборудованием и манипуляции ПО на себя !

---

h3. Текущий статус модифицированных прошивок

|_=. Доступный функционал для устройств XM      |_=. 06510              |_=. 18510              |_=. 18520              |_=. 23650 |
|<. Отправка снимков в группу Telegram          |={color:green}. да     |=. да                  |=. да                  |=. нет    |
|<. Отправка снимков на Яндекс.Диск             |={color:green}. да     |=. да                  |=. да                  |=. нет    |
|<. Отправка снимков на Google Drive            |=. *!*                 |=. !                   |=. !                   |=. !      |
|<. Отправка снимков в хранилище DropBox        |=. *!*                 |=. !                   |=. !                   |=. !      |
|<. Отправка снимков по протоколу MQTT          |={color:green}. да     |=. да                  |=. да                  |=. нет    |
|<. Отправка снимков на FTP сервера             |=. *тест*              |=. тест                |=. тест                |=. нет    |
|<. Организация L2/L3 VPN на базе VTUNd         |={color:green}. да     |=. да                  |=. да                  |=. тест   |
|<. Возможность доступа на камеру через UART    |={color:green}. да     |=. да                  |=. да                  |=. тест   |
|<. Возможность доступа на камеру через TELNETd |={color:green}. да     |=. да                  |=. да                  |=. тест   |
|<. Возможность доступа на камеру через SSHd    |={color:orange}. тест  |=. тест                |=. тест                |=. тест   |
|<. Возможность доступа на камеру через FTPd    |={color:orange}. тест  |=. тест                |=. тест                |=. тест   |
|<. Выполнение задач через запросы к INETd      |={color:orange}. тест  |=. тест                |=. тест                |=. тест   |
|<. Выполнение задач по расписанию через CRONd  |={color:green}. да     |=. да                  |=. да                  |=. нет    |
|<. Выполнение задач по команде из Telegram     |=. *!*                 |=. !                   |=. !                   |=. !      |
|<. Выполнение задач по команде из MQTT         |=. *!*                 |=. !                   |=. !                   |=. !      |
|<. Инструменты для отладки (ksyslogd, logread) |={color:green}. *да*   |={color:green}. *да*   |={color:green}. *да*   |=. тест   |
|<. Отправка телеметрии по протоколу MQTT       |={color:orange}. тест  |=. тест                |=. тест                |=. тест   |
|<. Возможность записи видео на USB Flash       |=. *тест*              |=. тест                |=. тест                |=. тест   |
|<. Возможность записи снимков на USB Flash     |=. *тест*              |=. тест                |=. тест                |=. тест   |
|<. Меню для настройки модулей в консоли        |={color:orange}. тест  |=. тест                |=. тест                |=. тест   |
|<. Альтернативный WEB-интерфейс (RO mode)      |={color:orange}. тест  |=. тест                |=. тест                |=. тест   |
|<. Поддержка USB Hub (только v.2.0)            |={color:green}. да     |=. ?                   |=. ?                   |=. нет    |
|<. Поддержка USB Flash (до 32Gb, VFAT)         |={color:green}. да     |=. ?                   |=. ?                   |=. нет    |
|<. Поддержка USB WiFi па чипсете MT7601        |={color:green}. да     |=. ?                   |=. ?                   |=. нет    |
|<. Поддержка USB WiFi па чипсете RTL8188       |={color:green}. да     |=. ?                   |=. ?                   |=. нет    |
|<. Поддержка USB WiFi па чипсете RT3070        |={color:green}. да     |=. ?                   |=. ?                   |=. нет    |
|<. Поддержка USB 3G/4G модемов (ACM)           |={color:orange}. тест  |=. ?                   |=. ?                   |=. нет    |
|<. Поддержка USB 3G/4G модемов (USBSERIAL)     |={color:orange}. тест  |=. ?                   |=. ?                   |=. нет    |
|<. Поддержка USB донглов LittleWire (I2C/1W)   |={color:orange}. тест  |=. ?                   |=. ?                   |=. нет    |
|<. Поддержка USB донглов Homes-smarT (GPIO/1W) |={color:orange}. тест  |=. ?                   |=. ?                   |=. нет    |
|                                               |                       |                       |                       |          |
...
h3. Архив прошивок и компонентов

p. Для удобства пользователей ссылки на файлы и каталоги с прошивками сведены в таблицу ниже.

|_=. Модель устройства     |_=. ID     |_=. Оригинальная прошивка                                                                                                                             |_=. Каталог прошивок от "ZFT Lab.":http://zftlab.org                                                             |
|/4=. IPC_HI3518E_50H10L   |/4=. 06510 |/4=. "IPC_HI3518E_50H10L":https://zftlab.org/files/firmware_ipcam/General_HZXM_IPC_HI3518E_50H10L_S38_V4.02.R12.Nat.OnvifS.20170727_ALL.bin           |=. "IPC_HI3518E_50H10L_NOWIFI":http://flyrouter.net/downloads/software/ipcam/IPC_HI3518E_50H10L_NOWIFI/          |
|/1=. "IPC_HI3518E_50H10L_MT7601":http://flyrouter.net/downloads/software/ipcam/IPC_HI3518E_50H10L_MT7601/          |
|/1=. "IPC_HI3518E_50H10L_RTL8188":http://flyrouter.net/downloads/software/ipcam/IPC_HI3518E_50H10L_RTL8188/        |
|/1=. "IPC_HI3518E_50H10L_RT3070":http://flyrouter.net/downloads/software/ipcam/IPC_HI3518E_50H10L_RT3070/          |
|=. IPC_HI3518EV200_50H10L |=. 18510   |=. "IPC_HI3518EV200_50H10L":https://zftlab.org/files/firmware_ipcam/General_HZXM_IPC_HI3518EV200_50H10L_S38_V4.02.R12.Nat.OnvifS.20171010_ALL.bin     |=. "IPC_HI3518EV200_50H10L_NOWIFI":http://flyrouter.net/downloads/software/ipcam/IPC_HI3518EV200_50H10L_NOWIFI/  |
|=. IPC_HI3518EV200_50H20L |=. 18520   |=. "IPC_HI3518EV200_50H20L":https://zftlab.org/files/firmware_ipcam/General_HZXM_IPC_HI3518EV200_50H20L_S38_V4.02.R12.Nat.OnvifS.HIK.20180104_ALL.bin |=. "IPC_HI3518EV200_50H20L_NOWIFI":http://flyrouter.net/downloads/software/ipcam/IPC_HI3518EV200_50H20L_NOWIFI/  |
|                          |           |                                                                                                                                                      |                                                                                                                 |

p. Для продвинутых пользователей доступны тестовые OpenSource прошивки (без поддержки Video, только ядро+сеть).

|_=. Группа устройств XM                          |_=. Успешные рапорты |_=. Ссылки на каталоги с прошивками                                                                        |
|<. Для любых камер на базе HI3518Cv1 и HI3518Ev1 |=. 06510             |={color:blue}. "тестирование":http://flyrouter.net/downloads/software/ipcam/Open_Source_Project/HI_SoC_v1/ |
|<. Для любых камер на базе HI3518Cv2 и HI3518Ev2 |=. 18510, 18520      |={color:blue}. "тестирование":http://flyrouter.net/downloads/software/ipcam/Open_Source_Project/HI_SoC_v1/ |
|                                                 |                     |                                                                                                           |

p. Компоненты для разработчиков прошивок (готовые программы и библиотеки) доступны по "ссылке":http://flyrouter.net/downloads/software/ipcam/For_Developers/

p. Убедительная просьба при использовании этих компонентов в своих проектах указывать первоисточник.
