...
p. Для разработчиков и продвинутых пользователей доступны тестовые OpenSource прошивки (без Video).

| Для любых устройств HI3518Cv1 и HI3518Ev1 |={color:blue}. тестирование |
| Для любых устройств HI3518Cv2 и HI3518Ev2 |={color:blue}. тестирование |
|                                           |                            |

p. Компоненты для разработчиков прошивок (готовые программы и библиотеки) доступны по ссылке "здесь.":http://flyrouter.net/downloads/software/ipcam/For_Developers/
