...
p. Для продвинутых пользователей доступны тестовые OpenSource прошивки (без поддержки Video, ядро+сеть).

| Для любых устройств HI3518Cv1 и HI3518Ev1 |={color:blue}. "тестирование":http://flyrouter.net/downloads/software/ipcam/Open_Source_Project/HI_SoC_v1/ |
| Для любых устройств HI3518Cv2 и HI3518Ev2 |={color:blue}. "тестирование":http://flyrouter.net/downloads/software/ipcam/Open_Source_Project/HI_SoC_v1/ |
|                                           |                                                                                                           |
