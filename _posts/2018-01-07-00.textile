...
p{color:red}. Убедительная просьба при использовании этих материалов с сайта в своих проектах указывать первоисточник. Спасибо!
...
p. Для продвинутых пользователей доступны экспериментальные *Open Source* прошивки и компоненты (см.ниже).
