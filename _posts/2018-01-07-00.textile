...
p. Файлы прошивок для IP камер размещены на серверах "ZFT Lab.":http://zftlab.org и "FlyRouter team":http://flyrouter.net

p. Для удобства пользователей сылки на них сведены в таблицу ниже.
