...
|_=. Доступный функционал для устройств XM      |_=. 06510              |
...
|<. Поддержка USB WiFi па чипсете MT7601        |={color:green}. *да*   |
|<. Поддержка USB WiFi па чипсете RTL8188       |={color:green}. *да*   |
|<. Поддержка USB WiFi па чипсете RT3070        |={color:green}. *да*   |
