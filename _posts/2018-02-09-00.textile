...
p. Данные прошивки предназначены только для опытных пользователей, умеющих работать с UART консолью и командами U-boot.

p. Сейчас тестируюется возможность загрузки ядра Linux на разных процессорах Hisilicon, работа интерфейсов Ethernet и USB, поддержка минимальной файловой системы, автоматическое детектирование сенсоров.
...
p. Скачайте тестовую прошивку под ваше устройство - Buildroot или OpenWrt
