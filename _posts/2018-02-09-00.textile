...
|_=. Список поддерживаемых платформ     |_=. "Buildroot":https://github.com/ZigFisher/hi35xx-buildroot firmware                           |_=. "OpenWrt":https://github.com/ZigFisher/chaos_calmer firmware                               |
