...
p. По-умолчанию, пароль для root не установлен. При необходимости выполните команду passwd для его изменения.
...
* Выбирайте imx122 для (вместо) imx322, если он отсутствует в списке сенсоров
* Выбирайте imx122 для (вместо) imx222, если он отсутствует в списке сенсоров
...
pre. -snapshotd -p /tmp/ -f snap.jpg rtsp://127.0.0.1:554/0-

p. -Получение снимков происходит при отправке сигнала SIGUSR1 демону snapshotd-

pre. kill -s SIGUSR1 `pidof snapshotd`
