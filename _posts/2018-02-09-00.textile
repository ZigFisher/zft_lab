...
p. Внимание! Если у вас камера не XM производителя и имеет на плате внешний Ethernet PHY (RTL8201 или IP101) - пробуйте использовать в первую очередь прошивки с именами -noXM.
...
|=. и разделение по типам Ethernet PHY  |=. for XM dev                                                                                  |=. for noXM dev                                                                                 |=. for XM dev                                                                                 |=. for noXM dev                                                                               |
...
p. Исходники прошивок и программ | "GitHub":https://github.com/ZigFisher | "Buildroot":https://github.com/ZigFisher/hi35xx-buildroot | "OpenWrt":https://github.com/ZigFisher/chaos_calmer | "Glutinium":https://github.com/ZigFisher/Glutinium
...
* "Hacking Jovision JVS-HI3518ESIV200":https://drive.google.com/drive/folders/1vimrJNaqoiK6gA02aLNeIFpeCcI8_Uhp
* "Hacking Haiwvision 960p":https://yadi.sk/d/G3EUYAH23SR4o6
