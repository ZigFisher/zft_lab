...
p. С 2018.02.21 начат сбор изаполнение информации в "OpenWrt Wiki":https://openwrt.org/docs/hardware/soc#hisilicon
...
p. Внимание! Если у вас камера не XM производителя и имеет на плате внешний Ethernet PHY (маленький квадратный чип RTL8201 или IP101) - пробуйте использовать в первую очередь прошивки с именами -for-notXM.

|_=. Список поддерживаемых платформ                     |_\2=. Сборка Buildroot                                                                           |_\2=. Сборка OpenWrt                                                                            |
|<. Для устройств с SoC HI3516Cv1, HI3518Cv1, HI3518Ev1 |=. "скачать":http://flyrouter.net/downloads/software/ipcam/Open_Source_Project/buildroot/soc_v1| |=. "скачать":http://flyrouter.net/downloads/software/ipcam/Open_Source_Project/openwrt/soc_v1 | |
|<. Для устройств с SoC HI3516Cv2, HI3518Cv2, HI3518Ev2 |=. "скачать":http://flyrouter.net/downloads/software/ipcam/Open_Source_Project/buildroot/soc_v2| |={color:green}. скоро                                                                         | |
|<. Для устройств с SoC HI3520Dv1, HI3521Dv1, HI3520?v2 |=\2{color:orange}. в разработке                                                                  |=\2{color:orange}. в разработке                                                                 |
|                                                       |                                                                                               | |                                                                                              | |
...
p. Теперь после загрузки устройство с прошивкой Buildroot и OpenWrt имеет одинаковый адрес - 192.168.1.10.
