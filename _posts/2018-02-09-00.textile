...
|<. Для любых устройств XM на базе HI3520?v1 и HI3521?v1 |={color:orange}. в разработке                                                             |={color:orange}. в разработке  |
|<. Для любых устройств XM на базе HI3520?v2             |={color:orange}. в разработке                                                             |={color:orange}. в разработке  |
|<. Для любых устройств Longse на базе HI3518Ev2         |={color:orange}. в разработке                                                             |={color:orange}. в разработке  |
|                                                        |                                                                                          |                               |
