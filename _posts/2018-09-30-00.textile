...
p. Помимо проекта "megatec":https://github.com/ZigFisher/Glutinium/tree/master/megatec там можно найти "25volt":https://github.com/ZigFisher/Glutinium/tree/master/25volt поддерживающий APC Smart-UPS и Powercom WOW UPS  с интерфейсом USB.
