---
layout:     post
title:      "Получение данных по протоколу Megatec с UPS Энергия ПН-500 и других"
tagline:    ""
category:   ""
group:      drafts
tags:       [linux, ups]
...
p. Все эксперименты проводились с имеющимся в наличии UPS Энергия ПН-500, но судя по отзывам, описанная методика подходит и под другие устройства этого производителя, которые имеют RS232 порт.
...
p. Команды, которые гарантированно поддерживают Энергия ПН-500 и старшие модели: F, I, Q1
...
p. Код будет доступен в самое ближайшее время в репозитории "Glutinium":https://github.com/ZigFisher/Glutinium
